...
namespace EasyFarm.PathingTools
{
    ...
    public class Pathing
    {
        ...
        public List<FFACE.Position> GetRemainingPath()
        {
            var NearestPoint = GetNearestPoint(GetPath());
            
            if (NearestPoint == null)
                return new List<FFACE.Position>();
            
            return Waypoints.SkipWhile(element => element != NearestPoint).ToList();
        }
    }
}