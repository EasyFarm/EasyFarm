...
namespace EasyFarm.Classes
{
    ...
    public class Wanderer
    {
        ...
        public bool CanMove()
        {
            return lastMoved.AddSeconds(MoveDelay) < DateTime.Now;
        }
        ...
        public FFACE.Position GetPosition(IEnumerable<FFACE.Position> positions, float distance)
        {
            ...
            origin.X = GenerateX(fface.Player.Position, boundingBox, distance);
            origin.Z = GenerateZ(fface.Player.Position, boundingBox, distance);

            // Create a point that represents the center of the bounding box. 
            var center = new FFACE.Position();

            center.X = new List<float>
            {
                boundingBox.XMin,
                boundingBox.XMax
            }.Average();

            center.Z = new List<float>
            {
                boundingBox.ZMin,
                boundingBox.ZMax
            }.Average();
